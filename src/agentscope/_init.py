...
from .web.client import StudioClient
...
def init_process(
    ...
    client = StudioClient(studio_url=studio_url)
    client.register_run(run_id=_runtime.runtime_id, project=project, name=name)
    _runtime._studio_client = client
    print("init _runtime studio client")
